...
import user from '../assets/icons/user.vg';
...
const Register = () => {
   const showPassword = () => {
      ...
      eyeCrossed.classNameList.toggle('active')
         ...
         <div className="login-box">
            ...
            <form>
               <div className="input-box">
                  <span><img src={user} className="user" /></span>
               ...
               <div className="input-box-2">
                  <span><img src={genders} className="genders" /></span>
               ...
               <span className="link-reg">Joined us before?<a href="#">Login!</a> </span>
            </form>
         </div>
      </div>
   );
